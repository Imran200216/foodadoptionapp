...
class UserGuestDetailsProvider extends ChangeNotifier {
  ...
  Future<void> saveUserAvatarForAnonymousAuth(
    ...
    try {
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) {
        return GuestUserNickNameScreen(userId: userId);
      }));
  ...
  Future<void> fetchGuestUserDetails(BuildContext context) async {
    _setLoading(true);
    try {
      QuerySnapshot querySnapshot =
          await _firestore.collection('userByAnonymousAuth').get();
